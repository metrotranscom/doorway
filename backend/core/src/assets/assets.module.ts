...
import { NullFileService } from "src/shared/uploads/null/null-file-service"
import { AmazonS3FileService } from "src/shared/uploads/aws/amazon-s3-file-service"
    ...
    [
      ...
      { provide: UploadService, useClass: CloudinaryService },
      {
        ...
        useFactory: (): FileServiceProvider => {
          ...
          return new FileServiceProvider(process.env.ASSET_FILE_SERVICE)
