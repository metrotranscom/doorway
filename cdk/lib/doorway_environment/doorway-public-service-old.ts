...
// export class DoorwayPublicService {
...
//     const executionRole = new Role(scope, "executionRole", {
...
//               secret.Secret.fromSecretNameV2(scope, "googleApiKey", "/doorway/GOOGLE_API_KEY")
//             ),
