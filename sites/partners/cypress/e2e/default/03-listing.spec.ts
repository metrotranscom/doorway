...
describe("Listing Management Tests", () => {
  ...
  it("full listing publish in Bay Area", () => {
    setupListingPublish(bayAreaListing)
    fillOutListing(cy, bayAreaListing)
    verifyDetails(cy, bayAreaListing)
    verifyAutofill(cy, bayAreaListing)
    verifyOpenListingWarning(cy, bayAreaListing)
  })

  it.skip("full listing publish in Bloomington", () => {
  ...
  it.skip("full listing publish in Angelopolis", () => {
  ...
  it("as admin user, should be able to download listings export zip", () => {
    ...
    const downloadFolder: string = Cypress.config("downloadsFolder")
