...
const ApplicationsList = () => {
  ...
  const isListingClosed = listingDto?.status === "closed"
  const isListingClosedAdmin = isListingClosed && profile?.userRoles?.isAdmin
              ...
              <AgTable
                ...
                headerContent={
                  <div className="flex-row">
                    {(!isListingClosed || isListingClosedAdmin) && (
                      <Button
