...
export const housingHelpLinkableCards: React.ReactElement<CardProps>[] = [
  ...
  >
    ...
    <Card.Section>
      {t("help.housingHelp.immediateHousingAssistanceHeader")}
    </Card.Section>
    <Card.Section>
      <DoorwayCollapsibleSection title={t("counties.fullname.Alameda")}>
        ...
        {t("help.housingHelp.immediate.alamedaBACSinfo")}<br /><br />
      ...
      <DoorwayCollapsibleSection title={t("counties.fullname.ContraCosta")}>
        <a href="https://cchealth.org/h3/coc/help.php">{t("help.housingHelp.immediate.contraCostaCHS")}</a>
        {t("help.housingHelp.immediate.contraCostaCHSinfo")}
      </DoorwayCollapsibleSection>
      <DoorwayCollapsibleSection title={t("counties.fullname.Marin")}>
        <a href="https://www.marinhhs.org/resources/Housing">{t("help.housingHelp.immediate.marinMCRG")}</a>
        {t("help.housingHelp.immediate.marinMCRGinfo")}
      </DoorwayCollapsibleSection>
      <DoorwayCollapsibleSection title={t("counties.fullname.Napa")}>
        <a href="https://www.countyofnapa.org/272/Homeless-Services">{t("help.housingHelp.immediate.napaNCHS")}</a>
      ...
      <DoorwayCollapsibleSection title={t("counties.fullname.SanMateo")}>
        <a href="https://www.smcgov.org/hsa/core-service-agencies-emergency-safety-net-assistance">{t("help.housingHelp.immediate.sanmateoHS")}</a>
        {t("help.housingHelp.immediate.sanmateoHSinfo")}
      </DoorwayCollapsibleSection>
      <DoorwayCollapsibleSection title={t("counties.fullname.SantaClara")}>
        <a href="https://osh.sccgov.org/need-assistance">{t("help.housingHelp.immediate.santaclaraOSH")}</a>
        {t("help.housingHelp.immediate.santaclaraOSHinfo")}<br /><br />
        <a href="https://www.billwilsoncenter.org/services/all/here4you.html">{t("help.housingHelp.immediate.santaclaraHCC")}</a>
        {t("help.housingHelp.immediate.santaclaraHCCinfo")}
      </DoorwayCollapsibleSection>
      <DoorwayCollapsibleSection title={t("counties.fullname.Solano")}>
        <a href="http://www.housingfirstsolano.org/get-help.html">{t("help.housingHelp.immediate.solanoHFS")}</a>
        {t("help.housingHelp.immediate.solanoHFSinfo")}
      </DoorwayCollapsibleSection>
      <DoorwayCollapsibleSection title={t("counties.fullname.Sonoma")}>
        <a href="https://sonomacounty.ca.gov/development-services/community-development-commission/divisions/homeless-services/get-help">{t("help.housingHelp.immediate.sonomaHS")}</a>
  ...
  >
    ...
    <Card.Section>
      ...
      <DoorwayCollapsibleSection title={t("counties.fullname.Alameda")}>
          ...
          {t("help.housingHelp.counseling.alamedaEdeninfo")}<br /><br />
      ...
      <DoorwayCollapsibleSection title={t("counties.fullname.SanMateo")}>
          ...
          {t("help.housingHelp.counseling.sanMateoHCinfo")}<br /><br />
      ...
      <DoorwayCollapsibleSection title={t("counties.fullname.SantaClara")}>
          ...
          {t("help.housingHelp.counseling.santaClaraHCinfo")}<br /><br />
          <a href="https://www.housing.org/tenants">{t("help.housingHelp.counseling.santaClaraPS")}</a>
  ...
  >
    ...
    <Card.Section>
      <DoorwayCollapsibleSection title={t("counties.fullname.Alameda")}>
          <a href="http://www.haca.net/">
            {t("help.housingHelp.vouchers.alamedaHAcounty")}
          </a>
          <br /><br />
          <a href="http://www.alamedahsg.org/">
